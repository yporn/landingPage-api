...
VALUES (
        'พนักงานเสิร์ฟชาย', '2', 'ประจำบ้านพักผู้บริหาร ต.จอหอ อ.เมืองนครราชสีมา จ.นครราชสีมา', '"มีหน้าที่ต้อนรับและเสิร์ฟอาหารผู้บริหาร ดูแลรักษามาตรฐานความปลอดภัยและสุขอนามัยของอาหาร"', 'เพศชาย อายุ 25-35 ปี', '2024-05-03', '2024-05-15', 'opening', 'published'
    ),
    (
        'วิศวกรประจำโครงการ', '1', 'อ.เมืองนครราชสีมา จ.นครราชสีมา', 'จัดเตรียมความพร้อมและวางแผนการทำงาน วางแผนการก่อสร้างโดยประสานและสอดคล้อง', 'เพศชาย อายุ 30 ปีขึ้นไป วุฒิปริญญาตรี สาขาวิศวกรรมโยธา', '2024-02-11', '2024-02-18', 'closed', 'unpublished'
    ),
    (
        'สถาปนิกโครงการ', '2', 'อ.เมืองนครราชสีมา จ.นครราชสีมา', 'ออกแบบงานด้านสถาปัตยกรรมให้ตรงตาม แผนงานที่กำหนดไว้ตรวจสอบความถูกต้องของแบบและรายการ', 'ไม่จำกัดเพศ อาย 25-35 ปี', '2024-03-02', '2024-03-30', 'opening', 'published'
    );

INSERT INTO
    projects (
        name, "index", heading, text, location, price, status_project, type_project, description, name_facebook, link_facebook, tel, address, link_location, display
    )
VALUES (
        'Project 1', 1, 'Project 1 Heading', 'Project 1 Text', 'Project 1 Location', 100000, 'ready', 'present', 'Project 1 Description', 'Project 1 Facebook', 'https://facebook.com/project1', '123456789', 'Project 1 Address', 'https://maps.google.com/project1', 'published'
    ),
    (
...
INSERT INTO
    project_house_type_items (project_id, name)
VALUES (1, 'Type A'),
    (1, 'Type B'),
    (2, 'Type C');
...
INSERT INTO
    project_desc_area_items (
        project_id, item, amount, unit
    )
...
INSERT INTO
    project_facility_items (project_id, item)
...
INSERT INTO
    promotion_house_models (
        "promotion_id", "house_model_id"
    )
VALUES (1, 1);

insert into
    promotion_free_items ("promotion_id", "description")
values (1, 'ฟรีโอน');

INSERT INTO
    interests (
        bank_name, interest_rate, note, display
    )
VALUES (
        'Bank A', '5', 'Interest rate for savings account', 'published'
    ),
    (
...
INSERT INTO
    activities (
        "index", heading, description, start_date, end_date, video_link, display
    )
VALUES (
        1, 'Activity 1', 'Description for Activity 1', '2024-05-01', '2024-05-31', 'https://youtube.com/activity1', 'published'
    ),
    (
